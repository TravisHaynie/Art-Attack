document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (images.length >= 2) {
            // Add 'data:image/png;base64,' to the src to display the image correctly
            imgPlayer1.src = `data:image/png;base64,${images[0].imageData}`; // Player 1's image
            imgPlayer2.src = `data:image/png;base64,${images[1].imageData}`; // Player 2's image
